...
public class MemberServiceTest {
    ...
    void setup() {
        ...
        memberService = applicationContext.getBean("memberService", MemberService.class);// new 객체 생성 대신, Bean으로 대체
    ...
    class Describe_join {
        ...
        class Context_with_saved_valid_member {
            ...
            void join() {
                ...
                //then
                assertThat(findMember).isEqualTo(findMember); // assertThat 검증메소드
            }
        }
    }
